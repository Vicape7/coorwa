...
// recoloured for Corwa. Zero dependencies: one WebGL canvas that fills its
...
//   1. The recipe colours are Corwa's, sampled from the logo - see UNIFORMS.
...
/**
 * The recipe. Colours are Corwa's, measured out of the logo file instead of
